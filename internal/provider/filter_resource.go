...
const (
	create_rs_filter = "/apps/filters.eda.nokia.com/v1alpha1/namespaces/{namespace}/filters"
	read_rs_filter   = "/apps/filters.eda.nokia.com/v1alpha1/namespaces/{namespace}/filters/{name}"
	update_rs_filter = "/apps/filters.eda.nokia.com/v1alpha1/namespaces/{namespace}/filters/{name}"
	delete_rs_filter = "/apps/filters.eda.nokia.com/v1alpha1/namespaces/{namespace}/filters/{name}"
)
